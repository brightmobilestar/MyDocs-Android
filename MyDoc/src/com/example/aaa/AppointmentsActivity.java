...
public class AppointmentsActivity extends Activity {
	...
	{		
		...
		if(nMode == 1)
		{
			...
			((EditText)findViewById(R.id.medication1what)).setText(Decode_string(record.doctor));
			((EditText)findViewById(R.id.txtAddress)).setText(Decode_string(record.address));
			((EditText)findViewById(R.id.medication1capsule)).setText(Decode_string(record.city));
			((EditText)findViewById(R.id.editMedicationCount)).setText(Decode_string(record.state));
			((EditText)findViewById(R.id.editOtherAllergies)).setText(Decode_string(record.zip));
			((EditText)findViewById(R.id.editMedicineAllergies)).setText(record.phone);
			((EditText)findViewById(R.id.editBirthday)).setText(Decode_string(record.mobile));
		...
		else
		{
			...
			((TextView)findViewById(R.id.editMedicineAllergies)).setText(record.phone);
		...
		if(nMode < 2)
		{
			...
			((EditText)this.findViewById(R.id.txtDate)).setOnFocusChangeListener(new View.OnFocusChangeListener() {
				...
				public void onFocusChange(View v, boolean hasFocus) {
					...
					{
						DateDialog();
						((EditText)findViewById(R.id.medication1what)).requestFocus();
					}
				}
			});
