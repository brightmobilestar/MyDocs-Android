...
public class OptometristActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		{
			Builder dlg = new AlertDialog.Builder(OptometristActivity.this);
			dlg.setMessage("There is no data about the Optometrist doctor");
			
			dlg.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int which) {
					Intent i = new Intent(OptometristActivity.this, ControlActivity.class);
					startActivity(i);
					finish();
				}
			});
		...
		if(nMode < 2)
		{
			setContentView(R.layout.new_optometrists);
			vg = (ViewGroup)findViewById(R.id.opt_new_ViewGroup);
		...
		{
			setContentView(R.layout.optometrists);
			vg = (ViewGroup)findViewById(R.id.opt_ViewGroup);
		}
	...
	private void setClickListener()
	{
		...
		((Button)findViewById(R.id.btnHome)).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(OptometristActivity.this, MainActivity.class);
		...
		if(nMode < 2)
		{
			((Button) findViewById(R.id.btnSave)).setOnClickListener(new OnClickListener(){
				public void onClick(View v) {
					...
					Intent intent = new Intent(OptometristActivity.this, SuccessWarningActivity.class);
	        		startActivity(intent);
