...
//			finish();
	...
	private void appendData_Specialist(int idx)
	{
		...
		((TextView)(newCell.findViewById(R.id.medication1what))).setText(Decode_string(record.Doctor));
	...
	private void appendData_Pharmacy(int idx)
	{
		...
		((TextView)(newCell.findViewById(R.id.medication1what))).setText(Decode_string(record.Pharmacy));
	...
	private void appendData_Insurance(int idx)
	{
		...
		((TextView)(newCell.findViewById(R.id.medication1what))).setText(Decode_string(record.Company));
