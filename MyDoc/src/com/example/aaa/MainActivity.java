...
//		mTts = new TextToSpeech(this, this);
     ...
     // To check out if it is paid or free version
        String strTemp = Decode_string(prefs.getString("status", "")); 
        if (strTemp.equals("")) {
        	//((LinearLayout) findViewById(R.id.blinearAddtionalDisable)).setVisibility(View.GONE);
		} else if (strTemp.equals("paid")) {
			((LinearLayout) findViewById(R.id.blinearAddtionalDisable)).setVisibility(View.GONE);
		} else if (strTemp.equals("free")) {
			((FrameLayout) findViewById(R.id.FragmentPaid)).setVisibility(View.GONE);
		}
    }
...
//		mTts.speak(strText, TextToSpeech.QUEUE_FLUSH, null);	
    ...
    private void setClickListener(){
		...
		((LinearLayout) findViewById(R.id.blinearAddtionalDisable)).setOnClickListener(new OnClickListener(){
...
//        		overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
		...
		((Button) findViewById(R.id.btnInfo)).setOnClickListener(new OnClickListener(){
			public void onClick(View v) {
				ControlActivity.nCategory = 8;
		...
		((Button) findViewById(R.id.btnLogin)).setOnClickListener(new OnClickListener(){
			public void onClick(View v) {
				ControlActivity.nCategory = 9;
				Intent intent = new Intent(MainActivity.this, RegisterHistoryLogActivity.class);
        		startActivity(intent);
        		speechToText("");
        		//finish();
			}
		...
		((Button) findViewById(R.id.btnHistory)).setOnClickListener(new OnClickListener(){
			public void onClick(View v) {
				ControlActivity.nCategory = 10;
				Intent intent = new Intent(MainActivity.this, LoginActivity.class);
        		startActivity(intent);
        		speechToText("");
        		//finish();
		...
		((Button) findViewById(R.id.btnLog)).setOnClickListener(new OnClickListener(){
			public void onClick(View v) {
				ControlActivity.nCategory = 11;
				Intent intent = new Intent(MainActivity.this, LoginActivity.class);
        		startActivity(intent);
        		speechToText("");
        		//finish();
